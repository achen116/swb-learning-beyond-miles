...
Organization.create!(
	...
	description: "My mission is to promote the use of beatboxing, and vocal mimicry, (human acts of imitating sounds with the mouth, nose and throat) as tools for individual and social healing and transformation. The challenge I am addressing is trying to (re)root beatboxing and vocal mimicry as art forms in cultures that foster individual social healing and transformation. Beatboxing is becoming more and more recognized as an vocal art form in the US and abroad, however it has become a novelty, and has become separated from its historical roots in the Hip Hop movement in New York as an tool for transforming difficult lives into something innovative, positive and groovy. All around the world beatboxing, and traditions of vocal mimicry, such as Inuit throat singing, shamanic animal imitation, nada sound yoga, and many other related practices are also being seen mostly as forms of entertainment, but are also, rooted in historical struggles for individual and social healing and transformation. The power of beatboxing and vocal mimicry to heal and transform the self and society is amazing on many levels, and deserves more attention and awareness than it is currently being given. The driving force behind my work is my experience with beatboxing and vocal mimicry as a tool to help me cure my own lyme disease through my own sonic energy, and my experience of their healing transformative powers across the globe.", 
	headquarters: "New Delhi, India", 
	theme_id: 1, 
	website: "http://www.beatboxwithoutborders.org", 
	image: "http://localhost:3000/imgs/beatbox-without-borders.png", 
...
Organization.create!(
	name: "Shadeism", 
	description: "Shadeism: Digging Deeper is a documentary about the discrimination based on skin tone that takes place in communities across the world. It is a follow-up feature doc to the original short 'Shadeism' (2010), which attempts to dissect and explore diverse stories behind the unhealthy obsession with lighter-tone skin among women of colour from different backgrounds. The issue of shadeism has a long history globally and is common in communities of colour. It is also an issue that people of colour experience whilst living as part of diasporic communities outside their native lands. Our film will examine and address the roots, realities, and effects of this issue on women from different walks of life.", 
	headquarters: "Toronto, ON", 
	theme_id: 2, 
	website: "http://www.shadeism.com", 
	image: "http://localhost:3000/imgs/shadeism.png", 
